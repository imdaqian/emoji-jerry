 ...
 *
 */
public class EmojiBeanParser {
    /**
     * No need for a constructor, all the methods are static.
     */
    private EmojiBeanParser() {}
    ...
    public static String parseToAliases(String input, FitzpatrickAction fitzpatrickAction) {
        ...
        for (EmojiBean emoji : EmojiBeanManager.getAll()) {
    ...
    public static String parseToUnicode(String input) {
        ...
        for (AliasCandidate candidate : candidates) {
            EmojiBean emoji = EmojiBeanManager.getForAlias(candidate.alias);
            if (emoji != null) {
     ...
     */
    public static String removeEmojis(String str, Collection<EmojiBean> emojisToRemove) {
        for (EmojiBean emoji : emojisToRemove) {
            if (emoji.supportsFitzpatrick()) {
                for (Fitzpatrick fitzpatrick : Fitzpatrick.values()) {
     ...
     * @return the string without the emojis that were removed
     */
    public static String removeAllEmojisExcept(String str, Collection<EmojiBean> emojisToKeep) {
        for (EmojiBean emoji : EmojiBeanManager.getAll()) {
