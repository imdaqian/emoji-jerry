...
public class EmojiBean {
     ...
     */
    protected EmojiBean(String description, boolean supportsFitzpatrick, List<String> aliases, List<String> tags, byte... bytes) {
     ...
     * If the modifier is null, then the result is similar to {@link EmojiBean#getUnicode()}
     *
    ...
    /**
     * Returns the String representation of the EmojiBean object.<br>
     * <br>
     * Example:<br>
     * <code>EmojiBean{description='smiling face with open mouth and smiling eyes', supportsFitzpatrick=false, aliases=[smile], tags=[happy, joy, pleased], unicode='😄', htmlDec='&amp;#128516;', htmlHex='&amp;#x1f604;'}</code>
     *
